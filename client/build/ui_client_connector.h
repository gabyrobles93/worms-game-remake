...
public:
    ...
    void retranslateUi(QMainWindow *client_connector)
    {
        ...
        ipLabel->setText(QApplication::translate("client_connector", "<html><head/><body><p><span style=\" font-weight:600; color:#000000;\">Host / IP</span></p></body></html>", Q_NULLPTR));
        portLabel->setText(QApplication::translate("client_connector", "<html><head/><body><p align=\"center\"><span style=\" font-weight:600; color:#000000;\">Port</span></p></body></html>", Q_NULLPTR));
        logoWorms->setText(QString());
        background->setText(QString());
        portBoxLabel->setText(QString());
        playerNameLabel->setText(QApplication::translate("client_connector", "<html><head/><body><p><span style=\" font-weight:600; color:#000000;\"> Name</span></p></body></html>", Q_NULLPTR));
        ipBoxLabel->setText(QString());
        nameBoxLabel->setText(QString());
        playerNameInput->setText(QApplication::translate("client_connector", "player", Q_NULLPTR));
        ipTextInput->setText(QApplication::translate("client_connector", "localhost", Q_NULLPTR));
        portTextInput->setText(QApplication::translate("client_connector", "8080", Q_NULLPTR));
    } // retranslateUi
