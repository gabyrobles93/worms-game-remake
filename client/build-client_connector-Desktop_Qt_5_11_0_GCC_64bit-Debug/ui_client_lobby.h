...
public:
    ...
    {
        client_lobby->setWindowTitle(QApplication::translate("client_lobby", "Form", nullptr));
        lobbyBackground->setText(QString());
        lobbyGamesImage->setText(QString());
        exitLobbyButton->setText(QApplication::translate("client_lobby", "Exit", nullptr));
        createGameButton->setText(QApplication::translate("client_lobby", "Create Game", nullptr));
        joinGameButton->setText(QApplication::translate("client_lobby", "Join Game", nullptr));
    } // retranslateUi
